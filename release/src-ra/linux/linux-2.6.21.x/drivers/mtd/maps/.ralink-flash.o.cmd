cmd_drivers/mtd/maps/ralink-flash.o := /opt/buildroot-gcc342/bin/mipsel-linux-uclibc-gcc -Wp,-MD,drivers/mtd/maps/.ralink-flash.o.d  -nostdinc -isystem /root/asuswrt-bender/tools/brcm/K26/hndtools-mipsel-uclibc-4.2.4/bin/../lib/gcc/mipsel-linux-uclibc/4.2.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2  -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ffreestanding  -march=mips32r2 -Wa,-mips32r2 -Wa,--trap -Iinclude/asm-mips/rt2880 -Iinclude/asm-mips/mach-generic -fomit-frame-pointer -gdwarf-2  -fno-stack-protector -membedded-data -muninit-const-in-rodata -funit-at-a-time -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ralink_flash)"  -D"KBUILD_MODNAME=KBUILD_STR(ralink_flash)" -c -o drivers/mtd/maps/ralink-flash.o drivers/mtd/maps/ralink-flash.c

deps_drivers/mtd/maps/ralink-flash.o := \
  drivers/mtd/maps/ralink-flash.c \
    ...
    $(wildcard include/config/mtd/nand/ralink.h) \
    ...
    $(wildcard include/config/part/size.h) \
    $(wildcard include/config/rootfs/in/flash/no/padding.h) \
    $(wildcard include/config/rootfs/flash/32m.h) \
  ...
  drivers/mtd/maps/ralink-flash.h \
    $(wildcard include/config/rt2880/flash/2m.h) \
    $(wildcard include/config/rt2880/flash/4m.h) \
    $(wildcard include/config/rt2880/flash/8m.h) \
    $(wildcard include/config/rt2880/flash/16m.h) \

drivers/mtd/maps/ralink-flash.o: $(deps_drivers/mtd/maps/ralink-flash.o)
